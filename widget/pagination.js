...
*@author  PeterYu
*@date    2017/12/12
*@package <div class="pagination-nick"></div>
**/
return function($){
//        定义一个分页方法，可多次调用
...
//              内容区填充数据
                ...
                arr.forEach(function(v){
                    //console.log(v);
                    str += '<li class="fl">'+
                                '<p><img src="'+v.imgsrc+'" alt=""></p>'+
                                '<p>'+v.title+'</p>'+
                                '<p><i class="iconfont icon-star color-orange"></i><i class="iconfont icon-star color-orange"></i><i class="iconfont icon-star color-orange"></i></p>'+
                                '<p><a href="javascript:;" class="inline">进入专区</a></p>'+
                                '<div class="game-wrap-con bg-white hide">'+
                                    '<p><img src="'+v.qrcode+'" alt=""></p>'+
                                    '<p>'+v.title+'</p>'+
                                    '<p><i class="iconfont icon-star color-orange"></i><i class="iconfont icon-star color-orange"></i><i class="iconfont icon-star color-orange"></i></p>'+
                                    '<p><a href="'+v.link+'" class="inline">进入专区</a></p>'+
                                '</div>'+
                            '</li>';
                /*str+='<div>'+v+'</div>';*/
                });
            ...
            function createOtherBtn(){
                $('.'+pager.paginationBox).html('<div class="'+pager.btnBox+'"><button data-page="prev" class="prev-btn">上一页</button><span class="'+pager.numBtnBox+'"></span><button data-page="next" class="next-btn">下一页</button></div>');
        ...
        paginationNick({
            ...
            mainBox:'game-wrap-middle',//内容盒子--必填
