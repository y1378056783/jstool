...
return function($) {
    ...
    KuCity.prototype = {
        ...
        creatItem: function() {
            ...
            var template = '<div class="kucity"><div class="citybox"><h3 class="kucity_header">选择游戏</h3><ul class="kucity_nav"><li class="active">热门城市</li><li>ABCDEFGH</li><li>IJKLMNOP</li><li>QRSTUVWXYZ</li></ul><div class="kucity_body"></div></div><ul class="result"></ul></div>';
    ...
    $.fn.kuCity = function(options) {
        ...
        target.on('focus', function(e) {
            ...
            //console.log(kucity.target);
            kucity.target.addClass('select').siblings('input').removeClass('select');
            kucity.init();
