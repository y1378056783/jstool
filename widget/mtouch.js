...
*touch常用事件封装
*
mTouch('#icon').on('tap',  function () {})//单击
				.on('doubletap',function(e){})//双击
				.on('longtap',function(e){})//长按
				.on('swipestart',function(e){})//滑动开始
				.on('swiping',function(e){})//滑动时
				.on('swipeend',function(){})//滑动结束
				.on('swipeleft',function(){})//滑动向左
				.on('swiperight',function(){})//滑动向右
				.on('swipeup',function(){})//滑动向上
				.on('swipedown',function(){})//滑动向下
 */
